...
public class ShareniuCommonJumpTaskCmd implements Command<Void> {
    ...
    public ShareniuCommonJumpTaskCmd(String executionId, String parentId, ActivityImpl destinationActivity, Map<String,Object> paramvar, ActivityImpl currentActivity) {
