...
public class ShareniuParallelJumpCmd implements Command<Void> {
    //执行实例id
    ...
    public ShareniuParallelJumpCmd(String executionId, String parentId, ActivityImpl destinationActivity, Map<String,Object> paramvar, ActivityImpl currentActivity) {
