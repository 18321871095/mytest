...
var ProcessDiagramGenerator = {	
	...
	/*showFlowInfo: function(flow){
		...
		/!*var TPL_FLOW_INFO = '<div><b>连线编号</b>:{flow}</div>'
				+ '<div><b>起始编号</b>: {sourceActivityId}</div>'
				+ '<div><b>目标编号</b>: {destinationActivityId}</div>';
	...
	*/
	...
	/*	var NodeType;var yibanren1;var weibanren2;var chakanren3;
        $.ajax({
            url: "/WebReport/processDiagram/getTaskNodePeopleInfo?proInstanceId="+myproInstanceId+"&activitiId="+activity.getId()+"&prodefinedId="+myprodefinedId,
            dataType: 'json',
            async: false,
            success: function(data, textStatus) {
                   yibanren1=data.result[0].myyibanren;
                   weibanren2=data.result[0].myweibanren;
                   chakanren3=data.result[0].mychakanren;
            }
        })*/
		...
		var values = {
			...
			type: NodeType*/
			/*yibanren:yibanren1,
			weibanren:weibanren2,
			chakanren:chakanren3*/
		};

		var TPL_ACTIVITY_INFO = '';
        /*+ '<div><img src="/WebReport/images/yicaozuo.jpg" width="30px" height="30px"><b>已办人：</b> {yibanren}</div>'
        + '<div><img src="/WebReport/images/weiban.jpg" width="30px" height="30px"><b>未办人：</b> {weibanren}</div>'
        + '<div><img src="/WebReport/images/chakan.jpg" width="30px" height="30px"><b>查看人：</b> {chakanren}</div>';*/
